...
R 
2
 . It handles edge cases such as perfect predictions and situations where all true values are identical.
...
def r_squared(y_true, y_pred):
    """
    Calculate the R-squared (RÃÂ²) coefficient of determination.
